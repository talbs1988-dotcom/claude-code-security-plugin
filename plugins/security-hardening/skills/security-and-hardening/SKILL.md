...
## שכבה 4 — כלל לסוכן מחובר-כלים (CLAUDE.md)

**מה:** אם ל-Claude יש גישה למייל, דרייב, CRM או אתרים (חיבורי MCP), Claude יוסיף ל-`~/.claude/CLAUDE.md`:
...
**למה:** שכבות 1–3 מגנות על סודות (.env, מפתחות). שכבה זו מגנה מפני prompt injection דרך **תוכן** — מייל, קובץ מהדרייב או דף אינטרנט שמכילים הוראות מוסתרות. קריטי כשמחוברים Gmail, Drive, Airtable או Make.
...
5. פתח `~/.claude/CLAUDE.md` והוסף קטע אבטחה (שכבה 3) אם חסר
6. הוסף את כלל הסוכן מחובר-הכלים (שכבה 4) אם חסר
7. הרץ את בדיקת התקינות ואשר שהכול ירוק
